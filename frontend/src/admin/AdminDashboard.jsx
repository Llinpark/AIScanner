    ...
    <div className="admin-dashboard">
      <div className="admin-stat-grid">
        ...
        <StatCard
          ...
          tone="warning"
          hint="Open or partial (TP1/TP2). Won/lost/expired/cancelled excluded."
        />
      ...
      {canManageScanner && (
        <div className="admin-panel">
          <div className="admin-panel-header">
            ...
            <span className="admin-pill status-inactive">Pipeline tab</span>
          </div>
          <p className="admin-table-meta">
            Telegram / MT5 success, delivered/failed, and pipeline latency live on the Pipeline tab.
            Overview does not recompute those counters.
          </p>
        </div>
      )}

      {canManageScanner && signalTotal === 0 && (
        <div className="admin-panel">
          <div className="admin-panel-header">
            <h3>Signal source</h3>
          ...
          <p className="admin-table-meta">
            Counters read unique ENTRY <code>signalUuid</code> documents. Production trades are ingested only from
            TradingView Pine webhooks — auto-scan does not create listable signals. Open the Pipeline tab to
            diagnose Pine generation vs webhook age.
          </p>
        </div>
      )}
