  ...
  const multi = registry.analyzeAll(
    {
      ...
      daytradingHtfCandles: options.htfCandles || options.daytradingHtfCandles || [],
...
/** Offline helper for FVG/breakaway candle math (not a selectable strategy). */
